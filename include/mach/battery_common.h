...
#define ANDROID_ONLY								0x1007
#define ANDROID_IPHONE_IDLE						0x1008
#define ANDROID_IPHONE_CHARGING					0x1009
#define ANDROID_IPHONE_COMMUNICATION			0x100a
#define ANDROID_IPHONE_COMMUNICATION_CHARGING	0x100b
#define AC_ANDROID_CHARGING						0x100c
#define AC_IPHONE_CHARGING						0x100d
#define HALL_NERA_EVENT                                  			0x2000
#define HALL_FAR_EVENT                                    			0x2001
#define USB_PLUG_IN_EVENT                              			0x2002
#define USB_PLUG_OUT_EVENT                           			0x2003
#endif
/*****************************************************************************
 *  CallState
 ****************************************************************************/
...
#if defined(VANZO_COMMON_APPLE_CHARGING)
extern void apple_charging_algorithm(void);
#endif
