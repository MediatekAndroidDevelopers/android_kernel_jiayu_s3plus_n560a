...
extern void apple_unmask_eint_plug_in(void);
extern void apple_mask_eint_plug_in(void);
extern int apple_vbus_android_connect_vbus_usb_flag;
void apple_boost_voltage_on(int is_on)
{
	...
	if(is_on)
	{
		...
		if(apple_vbus_android_connect_vbus_usb_flag)
			apple_mask_eint_plug_in();
		else
