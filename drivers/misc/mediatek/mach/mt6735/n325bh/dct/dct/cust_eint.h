...
#define CUST_EINT_VFSSPI_INT_IRQNO_NUM              1
#define CUST_EINT_VFSSPI_INT_IRQNO_DEBOUNCE_CN      0
#define CUST_EINT_VFSSPI_INT_IRQNO_TYPE							CUST_EINTF_TRIGGER_FALLING
#define CUST_EINT_VFSSPI_INT_IRQNO_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
...
#define CUST_EINT_CHR_STAT_NUM              63
