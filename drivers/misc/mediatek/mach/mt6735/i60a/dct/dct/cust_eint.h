...
#define CUST_EINT_CHR_STAT_DEBOUNCE_CN      128
#define CUST_EINT_CHR_STAT_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_CHR_STAT_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE

#define CUST_EINT_PLUG_IN_NUM              2
#define CUST_EINT_PLUG_IN_DEBOUNCE_CN      0
#define CUST_EINT_PLUG_IN_TYPE							CUST_EINTF_TRIGGER_LOW
#define CUST_EINT_PLUG_IN_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_DISABLE
