...
/* Vanzo:wuzhiyong on Wed 29 Apr 16:30:00 +8000
 * add button_backlight
 */
#define LCM_BUTTON_GPIO_PIN         (GPIO89 | 0x80000000)
...
static int button_backlight_set(int level)
{
  if(level > 0)
  {
  ...
  else
  {
    mt_set_gpio_mode(GPIO78, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO78, GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO78, GPIO_OUT_ZERO);
  }
}
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
    ...
    {"button-backlight",  MT65XX_LED_MODE_GPIO, (long)button_backlight_set,{0}},
