...
#ifdef GPIO_EXT_1V8_EN_PIN
            mt_set_gpio_mode(GPIO_EXT_1V8_EN_PIN,GPIO_MODE_00);
            mt_set_gpio_dir(GPIO_EXT_1V8_EN_PIN,GPIO_DIR_OUT);
            mt_set_gpio_out(GPIO_EXT_1V8_EN_PIN,GPIO_OUT_ONE);
#endif

        if (currSensorName && (0 == strcmp(currSensorName,"ov2710mipiraw")))
        {
