...
INT32 i4PicHdr(UINT32 u4InstID)
{
    ...
    switch (_u4PicStruct[u4InstID])
    {
        case 1:
            printk("<vdec> TOP_FLD_PIC\n");
            break;
        case 2:
            printk("<vdec> BTM_FLD_PIC\n");
            break;
        case 3:
            printk("<vdec> FRM_PIC\n");
            break;
        case 4:
            printk("<vdec> TWO_FLDPIC_TOPFIRST\n");
            break;
        case 5:
            printk("<vdec> TWO_FLDPIC_BTMFIRST\n");
            break;
        default:
            printk("<vdec> unknown pic structure \n");
            break;
    }
