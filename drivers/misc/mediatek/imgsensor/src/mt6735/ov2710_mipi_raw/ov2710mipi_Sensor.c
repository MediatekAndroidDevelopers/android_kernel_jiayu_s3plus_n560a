...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = OV2710MIPI_SENSOR_ID,  /*sensor_id = 0x2710*/ //record sensor id defined in Kd_imgsensor.h
...
//mdelay(5);                   
// PAD OUTPUT ENABLE 0x3016-0x3018
...
write_cmos_sensor(0x3714,0x4c);//write_cmos_sensor(0x3714,0x5c);
write_cmos_sensor(0x3710,0x9e);//
write_cmos_sensor(0x3801,0xc4);
write_cmos_sensor(0x3605,0x05);
write_cmos_sensor(0x3606,0x3f);
write_cmos_sensor(0x3616,0x48);//write_cmos_sensor(0x302d,0x90);
...
write_cmos_sensor(0x3a00,0x78);//write_cmos_sensor(0x3a00,0x00);
write_cmos_sensor(0x300f,0xc3);//write_cmos_sensor(0x300f,0x88);
write_cmos_sensor(0x3010,0x10);//write_cmos_sensor(0x3011,0x28);
write_cmos_sensor(0x3012,0x02);//null;
...
write_cmos_sensor(0x3010,0x00); //add
write_cmos_sensor(0x3503,0x37); //0x07
...
//write_cmos_sensor(0x3a00,0x38);
//write_cmos_sensor(0x3503,0x37);
//write_cmos_sensor(0x3011,0x1a);
	//mdelay(5);
	//preview_setting();
...
UINT32 OV2710MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
