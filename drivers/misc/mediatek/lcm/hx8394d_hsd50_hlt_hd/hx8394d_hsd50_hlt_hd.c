...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.lcm_esd_check_table[0].para_list[2] = 0x06;//06
#endif
...
//    params->dsi.lcm_esd_check_table[2].para_list[1] = 0x25;
...
static void lcm_init(void)
{
	...
	data_array[1]=0x15156aB1;// Set Power
	data_array[2]=0xF1110413;//34
	...
	data_array[1]=0x03FF00B4; // Set CYC
	...
	data_array[1]=0x000F00D3; //SET GIP
	...
	data_array[1]=0x181919D5; //SET GIP
	...
	data_array[0]=0x002D3902;
	data_array[1]=0x191818D6; //SET GIP
	...
	data_array[2]=0x0c302018; 
	data_array[3]=0x0a080530; 
	data_array[4]=0x13100d16; 
	data_array[5]=0x160a1311; 
	data_array[6]=0x00001c18; 
	data_array[7]=0x30201802; 
	data_array[8]=0x0805300c; 
	data_array[9]=0x100d160a; 
	data_array[10]=0x0a131113; 
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8394d_hsd50_hlt_hd_lcm_drv =
{
	.name           = "hx8394d_hsd50_hlt_hd",
