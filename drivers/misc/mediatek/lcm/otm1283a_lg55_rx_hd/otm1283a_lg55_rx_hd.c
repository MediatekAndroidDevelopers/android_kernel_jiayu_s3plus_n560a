...
{0xc0,2,{0x00,0x50}},  //50 // 50 column, 00 1dot 
...
static void lcm_get_params(LCM_PARAMS *params)
{
   ...
   // params->dsi.horizontal_blanking_pixel              = 60;
    ...
    params->dsi.PLL_CLOCK=240;//227;//254(124 0k)//247  //220
...
LCM_DRIVER otm1283a_lg55_rx_hd_lcm_drv = 
{
    .name			= "otm1283a_lg55_rx_hd",
