...
static struct LCM_setting_table lcm_initialization_setting[] = {
			...
			//--- power setting --------------------//
				...
				{0xc4,1,{0x05,0x10,0x06,0x02,0x05,0x15,0x10,0x05,0x10,0x07,0x02,0x05,0x15,0x10}},
			...
			//--- Gamma --------------------//
				{0x00,1,{0x00}},                                                                                    ////
				{0xE1,20,{0x00,0x0E,0x1A,0x23,0x33,0x41,0x42,0x71,0x65,0x86,0x7a,0x61,0x6f,0x44,0x45,0x33,0x25,0x16,0x08,0x00}},
  
				{0x00,1,{0x00}},
				{0xE2,20,{0x00,0x0E,0x1A,0x23,0x33,0x41,0x42,0x71,0x65,0x86,0x7a,0x61,0x6f,0x44,0x45,0x33,0x25,0x16,0x08,0x00}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.word_count = 720 * 3;
		...
		params->dsi.horizontal_backporch				= 0x2c ;//22
		params->dsi.horizontal_frontporch				= 0x2a ;//18
...
static unsigned int lcm_compare_id(void)
{
	...
	return (LCM_OTM1284_ID == ((id2 << 8) | id3)) ? 1 : 0;
}


LCM_DRIVER otm1284a_cpt50_xinli_hd_lcm_drv = 
{
    .name			= "otm1284a_cpt50_xinli_hd",
