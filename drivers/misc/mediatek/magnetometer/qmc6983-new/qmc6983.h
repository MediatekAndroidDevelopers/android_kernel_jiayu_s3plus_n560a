...
#define QMC6983_SET_RANGE		_IOW(QMC6983_IOCTL_BASE, 1, int)
#define QMC6983_SET_MODE		_IOW(QMC6983_IOCTL_BASE, 2, int)
#define QMC6983_SET_BANDWIDTH	_IOW(QMC6983_IOCTL_BASE, 3, int)
#define QMC6983_READ_MAGN_XYZ	_IOR(QMC6983_IOCTL_BASE, 4, int)	
#define QMC6983_SET_REGISTER_A	_IOW(QMC6983_IOCTL_BASE, 5, char *)
#define QMC6983_SELF_TEST	   _IOWR(QMC6983_IOCTL_BASE, 6, char *)
extern struct mag_hw* qmc6983_get_cust_mag_hw(void);
