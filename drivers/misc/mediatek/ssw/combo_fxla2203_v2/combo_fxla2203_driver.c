...
{
    printk("[ccci/ssw]COMBO_FXLA2203_V2\n");
...
static int extern_ssw_init(void) 
{
    ...
    SSW_DBG("GPIO_EXT_SSW_EN(%d, %d , %d)\n", \
        GPIO_EXT_SSW_EN,mt_get_gpio_mode(GPIO_EXT_SSW_EN), mt_get_gpio_out(GPIO_EXT_SSW_EN));
...
static int set_ext_sim_gpio(unsigned int mode)
{
    ...
    SSW_DBG("Current sim mode(%d), GPIO_EXT_SSW_S1(%d, %d , %d), GPIO_EXT_SSW_S2(%d, %d , %d), GPIO_EXT_SSW_EN(%d, %d , %d)\n", \
        mode, GPIO_EXT_SSW_S1,mt_get_gpio_mode(GPIO_EXT_SSW_S1), mt_get_gpio_out(GPIO_EXT_SSW_S1),\
        GPIO_EXT_SSW_S2,mt_get_gpio_mode(GPIO_EXT_SSW_S2), mt_get_gpio_out(GPIO_EXT_SSW_S2), \
              GPIO_EXT_SSW_EN,mt_get_gpio_mode(GPIO_EXT_SSW_EN), mt_get_gpio_out(GPIO_EXT_SSW_EN));
