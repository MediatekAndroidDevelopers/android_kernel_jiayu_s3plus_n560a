...
/* Vanzo:zhangxinyu on: Mon, 19 May 2014 21:04:25 +0800
 */
#ifdef TOUCH_PS
			tpd_driver_list[i].tpd_ps= tpd_drv->tpd_ps;
#endif
 ...
 */
#ifdef TOUCH_PS
void (* tpd_ps_enable)(bool on) = NULL;
#endif
// End of Vanzo:zhangxinyu
 ...
 */
#ifdef TOUCH_PS
				tpd_ps_enable = tpd_driver_list[i].tpd_ps;
#endif
// End of Vanzo:zhangxinyu
				break;
			}
