...
//	#include "FT5436I_20140124_app.i"
...
static ssize_t ft5x0x_debug_read(struct file *file, const char __user *buffer,
...

{
    ...
    copy_to_user(buffer,buf,num_read_chars);
	return num_read_chars;
}
static const struct file_operations ft_tool_fops = {
...
#else
    if(proc_create(PROC_NAME, 0660, NULL, &ft_tool_fops)== NULL)
    {
		dev_err(&client->dev, "Couldn't create proc entry!\n");
        return -1;
    }
